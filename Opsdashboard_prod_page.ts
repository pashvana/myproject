...
export class Opsdashboard_prod_page {
    readonly page: Page;
...
await this.opsdashboard.nth(1).click();
...
responseAppSharing.url().includes("https://reportingservice.unifysquare.com/api/v1/voicequality/"));
await new Promise(f => setTimeout(f, 2000));
...
responseAppSharing1.url().includes("https://reportingservice.unifysquare.com/api/v1/voicequality/"));
await new Promise(f => setTimeout(f, 2000));
...
responseAppSharing2.url().includes("https://reportingservice.unifysquare.com/api/v1/voicequality/"));
await new Promise(f => setTimeout(f, 2000));
...
const responseAppSharing3 = await this.page.waitForResponse((responseAppSharing3) => 
    responseAppSharing3.url().includes("https://reportingservice.unifysquare.com/api/v1/voicequality/"));
await new Promise(f => setTimeout(f, 2000));
