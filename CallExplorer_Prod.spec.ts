...
import { CallExplorer_prod_page } from '../../pages/XMO/CallExplorer_prod_page';
...
//Un skip below test when running on DEV env
  test.skip('Switch to Unifysquare Tenant',{tag:'@Regression'}, async ({  }) => {
    test.slow();
    const playwrightDev = new powersuit_Login_page(page);;
...
//Un comment below test when running on prod
  ...
  test('Navigate to Call Explorer Dashboard Page',{tag:'@preview'}, async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
  ...
  test.skip('Verify Download data as CSV',{tag:'@preview'}, async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
    await playwrightDev.Download_CSV_Data_To_verify();
  });
  test.skip('Verify Export Data JOb', async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
...
await playwrightDev.Verify_Event_Graph_And_LastDate();
  ...
  test.skip('Verify Download data as CSV For Audio Conference Page',async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
    await playwrightDev.Download_CSV_Data_To_verify();
  });
  test.skip('Verify Export Data JOb CSV For Audio Conference Page ', async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
    await playwrightDev.Verify_Export_Job();
  });
...
await playwrightDev.Verify_Event_Graph_And_LastDate_Filter();
  ...
  test.skip('Verify Download data as CSV For Custom Query -Multiple phone numbers Page',async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
    await playwrightDev.Download_CSV_Data_To_verify();
  });
  test.skip('Verify Export Data JOb CSV For Custom Query -Multiple phone numbers Page ', async ({  }) => {
    test.slow();
    const playwrightDev = new CallExplorer_prod_page(page);
    await playwrightDev.Verify_Export_Job();
  });